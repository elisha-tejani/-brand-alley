...
export const products: Product[] = [
  ...
  { id: 2, name: "Sable Midi Dress", price: 5200, category: "Dresses", icon: 1, tone: "blush", isNew: true },
  { id: 3, name: "Ribbed Turtleneck", price: 2600, category: "Essentials", icon: 2, tone: "clay" },
  { id: 4, name: "Pleated Trouser", price: 4100, category: "Essentials", icon: 3, tone: "sage", isNew: true },
  { id: 5, name: "Wrap Wool Coat", price: 9800, category: "Outerwear", icon: 4, tone: "orange", isNew: true },
